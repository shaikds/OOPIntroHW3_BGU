...
public class MainRun {
    ...
    public static void ArrayListTest() {
        ...
        System.out.println("Start remove myArrayList_3");
        ...
        System.out.println("Start remove myArrayList_4");
